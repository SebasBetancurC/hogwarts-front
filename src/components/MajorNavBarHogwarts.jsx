                                            ...
                                            <React.Fragment key={house.id}>
                                                <li>
                                                    <NavLink
                                                        ...
                                                        to={`/${house.name}`}
                                                        onMouseEnter={() => setHoveredHouse(house._id)}
                                                        onMouseLeave={() => setHoveredHouse(null)}
                                                        style={{
                                                            color: isActive || hoveredHouse === house._id ? house.colors[0] : "black",
                                                    ...
                                                    >
                                                        <img
                                                            src={(isActive || hoveredHouse === house._id) ? house.emblemHover : house.emblem}
                                                            alt={`${house.name} logo`}
                                                        ...
                                                        <div className="house-underline"
                                                            style={{
                                                                ...
                                                                width: "100%",
                                                                height: "10px",
                                                                transform: isActive || hoveredHouse === house._id ? "scaleX(1)" : "scaleX(0)",
